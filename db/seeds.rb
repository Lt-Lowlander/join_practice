...
Challenge.create(title: "Bangers & Mosh!", description: "British Punk Bed and Breakfast startup", number_of_users: 2)
Challenge.create(title: "Antigravity Tapestry", number_of_users: 2)
Challenge.create(title: "Local Zap", description: "Liven up your neighborhood for the weekend.", number_of_users: 3)
Challenge.create(title: "Inverted-Phase Gastronomy", description: "Enjoy brussels sprouts like never before", number_of_users: 2)
